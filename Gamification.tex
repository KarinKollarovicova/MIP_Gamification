...
\section{Gamification in use} \label{section4}
	Gamification has been proves very useful over the past few years.
	As an exampl,e we can take a look at some of the most famous apps or websites which use gamification. Duolingo, Kahoot or even a project from MIT called Scratch. 
	Scoreboards, daily challanges or experience points are something players/learners find in the duolingo app. Same as in while using Kahoot, students are challenged which motivates the to work hared. 
	Scartch is essentially a programming language mainly for youger students or for beginners. 
	It proveds the perfect introdution int ot he programming world by showing colourful command along with real-time fun animations of the created programm.
	All of these have implemented gaming techniques which ensure that the user learns something while having fun. The all ar every user firendly and well designed. 

	To prove the theory, a reasearch was done. A team of reseachers used an online learning environment called PeerSpace, which was designed to help with social interaction and engagement but was not as successful as it could be.
